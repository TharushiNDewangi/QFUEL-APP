...
public class UserAddFuelDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_add_fuel_details);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (txtlocation.isEmpty() && txttype.isEmpty() && txtstart.isEmpty() && txtend.isEmpty()) {
                    Toast.makeText(UserAddFuelDetails.this, "Please enter All the values", Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
    ...
    private void postStationOwnerDetails(String location, String type,String start,String end) {
        ...
        call.enqueue(new Callback<StationOwner>() {
            ...
            public void onResponse(Call<StationOwner> call, Response<StationOwner> response) {
                Toast.makeText(UserAddFuelDetails.this, "Successfully entered to API", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<StationOwner> call, Throwable t) {
                Toast.makeText(UserAddFuelDetails.this, "ERROR!!!", Toast.LENGTH_SHORT).show();
            }
        });
